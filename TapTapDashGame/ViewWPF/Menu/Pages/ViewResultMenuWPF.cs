...
{
  /// <summary>
  /// Представление меню результатов игры в WPF
  /// </summary>
  public class ViewResultMenuWPF : ViewResultMenu
  {
    /// <summary>
    ...
    /// <summary>
    /// Конструктор для инициализации меню результатов игры
    /// </summary>
    /// <param name="parMenu">Модель меню с результатами</param>
    public ViewResultMenuWPF(ResultMenu parMenu) : base(parMenu)
    {
    ...
    /// <summary>
    /// Добавить информацию о счете игрока
    /// </summary>
    private void AddScoreInformation()
    {
      TextBlock scoreInfo = new()
      {
        Text = TextConstants.MenuResultItemScore + Rating.CurrentPlayer.CurrentScore.ToString(),
        FontSize = 40,
        FontFamily = Properties.WPF_APPLICATION_FONT,
        Foreground = Properties.WPF_COLOR_TEXT_HEADING,
        Margin = new(0, 20, 0, 20),
      ...
      StackPanel.Children.Insert(1, scoreInfo);
    }

    /// <summary>
    /// Отображение меню с результатами игры
    /// </summary>
