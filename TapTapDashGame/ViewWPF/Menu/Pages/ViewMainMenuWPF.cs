...
{
  /// <summary>
  /// Представление главного меню игры в WPF
  /// </summary>
  public class ViewMainMenuWPF : ViewMainMenu
  {
    /// <summary>
    ...
    /// <summary>
    /// Конструктор для инициализации главного меню
    /// </summary>
    /// <param name="parMenu">Модель главного меню</param>
    public ViewMainMenuWPF(MainMenu parMenu) : base(parMenu)
    {
      Init();
    }
