...
{
  /// <summary>
  /// Представление меню проигрыша в консоли
  /// </summary>
  public class ViewFailMenuConsole : ViewFailMenu
  {
    /// <summary>
    /// Конструктор представления
    /// </summary>
    /// <param name="parMenu">Меню с ошибкой</param>
    public ViewFailMenuConsole(FailMenu parMenu) : base(parMenu)
    {
      InitItems();
    }
